    ...
    <div class="fr-calc">
      ...
      <div class="fr-calc-uit">
        ...
        <div class="fr-form" style="margin-top:18px">
          ...
          <p class="fr-hint" id="ca-mandje-uitleg">Bestellen bij Oaklyn zet deze materiaallijst in de winkelwagen van de webshop; daar log je in en reken je af op je partnerprijs. Losse artikelen vind je in <a href="${OAKLYN}" target="_blank" rel="noopener">de webshop</a>.</p>
